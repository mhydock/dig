...
export class ToolsInventory {
  ...
  private tools: { [key: string]: Tool } = {
    ...
    SXcvtr: new Tool(
      ...
      1000,
      25000,
      this.techTree.SHOVEL,
      1,
      2
    ), // small, Bobcat-esque excavator
    HydMin: new Tool(
      "Hydraulic Mining",
      0,
      2000,
    ...
    MXcvtr: new Tool(
      ...
      1,
      3
    ), // small/medium construction excavator
    ...
    LXcvtr: new Tool(
      ...
      1,
      4
    ), // large construction excavator
    PolExp: new Tool(
      "Polymer Explosives",
      0,
      40000,
      150000,
      this.techTree.EXPLOS,
      1,
      2
    ),
    GDrill: new Tool(
      ...
      1,
      4
    ), // Big Bertha, world's largest drill
    Bagger: new Tool(
      "GIANT EXCAVATOR",
      0,
      200000,
      ...
      1,
      5
    ), // Bagger 293, world's largest excavator
    NukExp: new Tool(
      "Nuclear Explosives",
      0,
      400000,
